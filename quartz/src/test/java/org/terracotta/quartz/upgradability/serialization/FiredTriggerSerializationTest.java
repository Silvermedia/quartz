 ...
 * @author cdennis
 */
public class FiredTriggerSerializationTest {
 
  @Test
  public void testSimple() throws IOException, ClassNotFoundException {
    FiredTrigger ft = new FiredTrigger("client-id", new TriggerKey("name", "group"), 10, 9);
    validateSerializedForm(ft, "serializedforms/FiredTriggerSerializationTest.testSimple.ser");
  }
}
